use blind_image_steganography::{CountOfLeastSignificantBits, Image, ImageFormat, InsertConfig};
...
fn main() {
    ...
    let conf = InsertConfig::builder()
        ...
        .count_of_least_significant_bits_in_green(CountOfLeastSignificantBits::Four)
        .count_of_least_significant_bits_in_blue(CountOfLeastSignificantBits::Six)
    ...
    m.save_to_file("kek.wep", ImageFormat::WebP);
}
